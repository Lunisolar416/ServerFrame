...
static mysylar::ConfigVar<uint64_t>::ptr g_http_request_buffer_size = mysylar::Config::Lookup(
    "http.request.buffer_size", (uint64_t) (4 * 1024), "http request buffer size");

static mysylar::ConfigVar<uint64_t>::ptr g_http_request_max_body_size = mysylar::Config::Lookup(
    "http.request.max_body_size", (uint64_t) (64 * 1024 * 1024), "http request max body size");

static mysylar::ConfigVar<uint64_t>::ptr g_http_response_buffer_size = mysylar::Config::Lookup(
    "http.response.buffer_size", (uint64_t) (4 * 1024), "http response buffer size");

static mysylar::ConfigVar<uint64_t>::ptr g_http_response_max_body_size = mysylar::Config::Lookup(
